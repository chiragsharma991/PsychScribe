...
import com.psychscribe.inappbill.AppProperties;
import com.psychscribe.inappbill.items.Passport;
import com.psychscribe.inappbill.util.IabHelper;
import com.psychscribe.inappbill.util.IabResult;
import com.psychscribe.inappbill.util.Log;
import com.psychscribe.inappbill.util.Purchase;
...
public abstract class PurchaseActivity extends BlundellActivity implements IabHelper.OnIabSetupFinishedListener, IabHelper.OnIabPurchaseFinishedListener {
    ...
    public void onIabPurchaseFinished(IabResult result, Purchase info) {
        ...
        {
        	if (Passport.SKU.equals(info.getSku()))
        	{
    ...
    protected void dealWithPurchaseFailed(IabResult result) 
    {
        ...
        if(result.getResponse()==-1005)
            IabHelper.isInAppDialogClose=true;
    }
