 ...
 * 
 * CommonAsync note about threading: When using this object from a background thread, you may
...
public class IabHelper {
    ...
    public static boolean isAlreadyPurchesd = false;
    public static boolean isInAppDialogClose = false;
     ...
     * 
     * THIS WILL NOT WORK ON an EMULATOR, YOU NEED CommonAsync REAL DEVICE
     * 
     * @param listener
     ...
     * @param requestCode
     *            CommonAsync request code (to differentiate from other responses --
     ...
     * @param code
     *            The response code
     * @return CommonAsync human-readable string explaining the result code.
    ...
    public static String getResponseDesc(int code) {
        ...
        else
        {
        	...
        	if(code == 5)
        	{
        		isInAppDialogClose = true;
        	}
        	if(code == 7)
        	{
        		isAlreadyPurchesd = true;
        	}
