...
public class CircularJumpProgress extends View {
    ...
    public CircularJumpProgress(Context context) {
        this(context, null);
    }

    public CircularJumpProgress(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularJumpProgress(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorTrasparentBlue));
    }
